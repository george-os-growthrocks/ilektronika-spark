...
const PAYMENT_SOURCE = "https://vapeandmore.gr/%cf%80%ce%bb%ce%b7%cf%81%cf%89%ce%bc%ce%ae-%cf%80%ce%b1%cf%81%ce%ac%ce%b4%ce%bf%cf%83%ce%b7/";
const SECURITY_SOURCE = "https://vapeandmore.gr/%ce%b1%cf%83%cf%86%ce%ac%ce%bb%ce%b5%ce%b9%ce%b1-%cf%83%cf%85%ce%bd%ce%b1%ce%bb%ce%bb%ce%b1%ce%b3%cf%8e%ce%bd/";

export const Route = createFileRoute("/apostoles-epistrofes")({
  head: () => ({
    meta: [
      { title: "Αποστολές, Πληρωμές & Επιστροφές | ilektronikatsigara.gr" },
      { name: "description", content: "Τρόποι πληρωμής, αποστολή ACS / ΕΛΤΑ Courier, επιστροφές και ασφάλεια συναλλαγών μέσω vapeandmore.gr." },
      ...
      <div className="space-y-8 text-foreground/90">
        <section>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li><strong>Δωρεάν αποστολή</strong> για παραγγελίες άνω των 30€.</li>
        ...
        <section>
          ...
          <p className="text-sm mt-3">
            ...
            <a href={PAYMENT_SOURCE} target="_blank" rel="noopener noreferrer" className="text-primary underline">vapeandmore.gr/πληρωμή-παράδοση</a>.
          </p>
        </section>

        <section>
          <h2 className="text-xl font-extrabold mb-2">🔒 Ασφάλεια συναλλαγών</h2>
          <p>SSL κρυπτογράφηση σε όλο τον ιστότοπο, PCI-DSS συμμόρφωση μέσω του παρόχου πληρωμών. Καμία αποθήκευση στοιχείων κάρτας στους servers του καταστήματος.</p>
          <p className="text-sm mt-2">
            Αναλυτικά:{" "}
            <a href={SECURITY_SOURCE} target="_blank" rel="noopener noreferrer" className="text-primary underline">vapeandmore.gr/ασφάλεια-συναλλαγών</a>.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>Επικοινωνία πριν την επιστροφή: <a href="mailto:info@vapeandmore.gr" className="text-primary underline">info@vapeandmore.gr</a>.</li>
          </ul>
        </section>
      </div>
