...
export const Route = createFileRoute("/katigories")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Όλες οι κατηγορίες | ilektronikatsigara.gr" },
      { property: "og:url", content: "/katigories" },
    ],
    links: [{ rel: "canonical", href: "https://vapeandmore.gr/product-category/" }],
  }),
      ...
      <section className="py-12 bg-surface border-b border-border">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-muted-foreground mt-2 max-w-2xl">
            Περιηγηθείτε σε ολόκληρο τον κατάλογο της Vape and More — από
            ηλεκτρονικά τσιγάρα μέχρι αξεσουάρ ναργιλέ.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-12 border-t border-border">
        ...
        <div className="flex flex-wrap gap-2">
          {topBrands.map((b) => (
            ...
            >
              {b.label}{" "}
              <span className="text-muted-foreground font-mono ml-1">({b.count})</span>
            </Link>
          ))}
        </div>
      </section>
