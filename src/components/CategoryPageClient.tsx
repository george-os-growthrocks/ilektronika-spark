...
import { categoryDescription } from "@/data/faqs-generated";
          ...
          {totalPages > 1 && (
            <nav className="flex justify-center items-center gap-2 mt-10" aria-label="Pagination">
              <Link
                ...
                className="px-3 py-2 text-xs font-bold border border-border rounded hover:border-primary disabled:opacity-40 pointer-events-none opacity-40"
